...
//  FoodPin
//
//  Created by Дмитрий Поздняков on 15.02.2022.
//
...
struct RestaurantListView: View {
    ...
    @State var restuarantIsFavorites = Array(repeating: false, count: 21)
...
struct RestaurantListView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        /*
        BasicTextImageRow(imageName: "cafedeadend", name: "Cafe Deadend", type: "Cafe", location: "Hong Hong", isFavorite: .constant(true))
            .previewLayout(.sizeThatFits)
        
        FullImageRow(imageName: "cafedeadend", name: "Cafe Deadend", type: "Cafe", location: "Hong Hong", isFavorite: .constant(true))
            .previewLayout(.sizeThatFits)
    ...
    var body: some View {
        ...
        .contextMenu{
            ...
            Button(action: {
                ...
                HStack {
                    Text(restaurant.isFavorite ? "Remove from favourites" : "Mark as favorite")
                    Image(systemName: "heart")
                }
            }
            /*
